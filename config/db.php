...
// user for your database. the user needs to have rights for SELECT, UPDATE, DELETE and INSERT. by the way, it's bad
// style to use "root". In a real application you should create a database user that fits your needs.
define("DB_USER", "root");
